...
### Outlined Button
```tsx
className="border border-outline-variant text-primary rounded-lg px-8 py-4 text-label-md font-jakarta hover:bg-surface-container-low"
```
...
### Input Field
```tsx
className="bg-surface-container-lowest border border-outline-variant rounded text-body-md font-jakarta px-4 py-3 focus:border-primary focus:border-[1.5px]"
```

### Chip (Category)
```tsx
className="bg-primary-fixed text-on-primary-fixed-variant rounded-full px-4 py-1.5 text-label-md uppercase"
```
