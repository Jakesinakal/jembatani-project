...
export function Badge({ children, variant = 'default', className = '' }: BadgeProps) {
  const baseStyle = 'inline-flex items-center justify-center text-body-sm font-bold tracking-wider px-2.5 py-1 rounded-full uppercase font-jakarta';
  ...
  const variantStyles = {
    ...
    organic: 'bg-surface-container text-on-surface border border-outline-variant text-body-sm font-medium normal-case',
    // Featured / Spotlight
